'''
This script implements different image classification models in PyTorch
Models are initialiizeds with ImageNet Weights by default (stored locally)
Certain layers of models can be frozen
'''
