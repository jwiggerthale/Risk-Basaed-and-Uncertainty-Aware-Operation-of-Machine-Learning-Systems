'''
This script implements functions to calculate model performance
'''
...
'''
Function calculates expectes risk for a confusion matrix (class conditional) and a cost matrix
Call with:
    P: np.array --> class conditional probability matrix
    C: np.arry --> cost matrix
'''
