'''
This script implements different models in PyTorch
All models by default load image net weights (from local path)
Certain parts of model can be frozen by defined functions
'''
