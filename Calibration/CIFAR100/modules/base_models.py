...
'''
This class implements a VGG16 model where 
  - weights can be frozen
  - number of classes can be adapted to needs
Model is initialized with (locally downloaded) ImageNet weights
# not used for thesis
'''
...
'''
This class implements a EfficientNet-B0 model where 
  - weights can be frozen
  - single layers can be frozen
...
'''
This class implements a VIT model where 
  - weights can be frozen
  - single layers can be frozen
  - dropout can be added
  - number of classes can be adapted to needs
...
'''
This class implements a ResNet18 with added dropout layers where 
  - weights can be frozen
  - single layers can be frozen
  - number of classes can be adapted to needs
Model is initialized with (locally downloaded) ImageNet weights
