'''
This script implements different base models applicable for ensemble and softmax models
    --> for softmax either uncomment softmax in forward pass or add softmax call to your training loop
Models are implemented in PyTorch and initialized with ImageNet weights (stored locally)
'''
